...
<body>
	...
	<div class = "container d-flex mt-4">
		<% for(Map<String,Object> book : list){ 
				if(String.valueOf(book.get("id")).equals(bookId)){
		
		%>
			
			<img width = "300" height = "400" src = <%= book.get("image") %>>
			<div class ="ml-3">
				<h1 class = "font-weight-bold display-1"><%= book.get("title") %></h1>
				<h3 class = "display-3 text-primary"><%= book.get("author") %></h3>
				<h4 class = "display-4"><%= book.get("publisher") %></h4>
			</div>
		<%		} 
		} %>
