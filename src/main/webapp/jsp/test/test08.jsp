...
<body>
	...
	<table class = "table text-center">
		...
		<% String link = "/jsp/test/test08-bookInfo.jsp?bookId=" + book.get("id"); %>
			<tr>
				<td><%= book.get("id") %></td>
				<td><img width = "100" height = "150" alt = "책 사진" src = <%= book.get("image") %> ></td>
				<td><a class = "display-4" href = "<%= link %>" target = "_blank"><%= book.get("title") %></a> </td>
